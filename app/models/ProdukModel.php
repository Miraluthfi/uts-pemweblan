<?php
    class ProdukModel { // buat methodnya
        private $table = 'tb_ponsel'; //untuk menyimpan nama tabel
        private $db; 
        ...
        {
            $this -> db -> query('SELECT * FROM ' . $this -> table); // ambil semua data tabel id_ponsel dari database
            return  $this -> db -> resultAllSet(); //sumber -> app/core/database.php (ambil data dari database)
        }
        ...
        public function tambahData($data, $file){ //nampilin id
